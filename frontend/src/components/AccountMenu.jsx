    ...
    return (
        <>
            ...
            <div ref={menuRef} className="relative">
                {isOpen && (
                    isSimpleMode ? (
                        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex flex-col justify-end p-0 sm:p-4 animate-fadeIn">
                            <div className="w-full max-w-lg mx-auto bg-[var(--surface)] border-t sm:border border-[var(--border)] rounded-t-3xl sm:rounded-3xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-scaleUp">
                                {/* MODAL HEADER */}
                                <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--border)] bg-[var(--surface-accent)]/50">
                                    <div className="flex items-center gap-2">
                                        <div className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-lg font-black text-xs ${avatarGradient}`}>
                                            {storeInitial}
                                        </div>
                                ...
                                <div className="overflow-y-auto flex-1">
                                    ...
                                    <div className="border-b border-[var(--border)] bg-[var(--surface-accent)]/30 p-4">
                                    ...
                                    <div className="p-2 space-y-1">
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-500/15 text-slate-600 dark:text-slate-400 border border-slate-500/20">
                                                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-[11px] text-[var(--text-secondary)]">
                                                        Condiciones del servicio y políticas
                                                    </span>
                                                </div>
                                            </div>
                                            <span className="text-xs text-[var(--text-secondary)] group-hover:text-[var(--text-primary)] transition">
